...
if (isset($qode_options_river['hide_contact_form_website'])) $hide_contact_form_website = $qode_options_river['hide_contact_form_website'];
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<?php } ?>
		<?php if($qode_options_river['enable_google_map'] == "yes"){ ?>
		...
		<div class="container_inner<?php echo $container_class; ?> clearfix">
				<div class="contact_detail">
					...
					<?php if($qode_options_river['enable_contact_form'] == "yes"){ ?>
						...
						<div class="column2">
							<div class="column_inner">
								<div class="contact_form">
									<h6><?php if($qode_options_river['contact_heading_above'] != "") { echo $qode_options_river['contact_heading_above'];  } else { ?><?php _e('CONTACT US', 'qode'); ?><?php } ?></h6>
									<form id="contact-form" method="post" action="">
										...
										if($qode_options_river['use_recaptcha'] == "yes") :
											...
											if($qode_options_river['recaptcha_public_key']) {
												$publickey = $qode_options_river['recaptcha_public_key'];
											} else {
												$publickey = "6Ld5VOASAAAAABUGCt9ZaNuw3IF-BjUFLujP6C8L";
											}
											if($qode_options_river['recaptcha_private_key']) {
												$privatekey = $qode_options_river['recaptcha_private_key'];
											} else {
												$privatekey = "6Ld5VOASAAAAAKQdKVcxZ321VM6lkhBsoT6lXe9Z";
											}

											if($qode_options_river['page_transitions'] != ""){ ?>
