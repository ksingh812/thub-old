	...
	<?php get_header(); ?>
		...
		<div class="container">
			<div class="container_inner clearfix">
				...
				<div class="row">
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'concerts','posts_per_page' => 160);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						$postid = get_the_ID();?>
						<div class="col-md-2">
						 <a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );?> <img src="<?php echo $url; ?>" width="100px" height="100px" alt="<?php the_title();?>"><?php the_title(); ?></a>
						 </div>
						<?php endwhile; endif; ?>
						<?php wp_reset_query(); ?>
				</div>
