			...
			<div class="container_inner clearfix">
				...
				<div class="wpb_row vc_row-fluid" style="text-align:left;">
					...
					<div class="box_holder" style="border-color:#D8D8D8;"><div class="box_holder_inner left">
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'Concerts', 'tag' => 'featured', 'posts_per_page' => 5);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						?>
						 <b><a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );?> <img src="<?php echo $url; ?>" alt="<?php the_title();?>" width="32" height="32" style="vertical-align:middle; margin-right:10px; border-style:solid; border-width:0px; border-radius:20px;" /><?php the_title(); ?><span style="float:right;"><i class="icon-ticket"></i></span></a></b></br>
						<?php endwhile; endif; ?></p>
						<?php wp_reset_query(); ?></br>
						<span style="float:right;"><a href="http://www.tickethub.co/concerts">All Concerts</a></span>
					</div></div>
				</div> 
			</div> 
			<div class="vc_span4 wpb_column column_container">
					...
					<div class="box_holder" style="border-color:#D8D8D8;"><div class="box_holder_inner left">
						<p>
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'Theater', 'tag' => 'featured', 'posts_per_page' => 5);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						$postid = get_the_ID();?>
						 <b><a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );?> <img src="<?php echo $url; ?>" alt="<?php the_title();?>" width="32" height="32" style="vertical-align:middle; margin-right:10px; border-style:solid; border-width:0px; border-radius:20px;" /><?php the_title(); ?><span style="float:right;"><i class="icon-ticket"></i></span></a></b></br>
						<?php endwhile; endif; ?></p>
						<?php wp_reset_query(); ?>
						<span style="float:right;"><a href="http://www.tickethub.co/theaters">All Theater</a></span>
					</div></div>
				</div> 
			</div> 
			<div class="vc_span4 wpb_column column_container">
					...
					<div class="box_holder" style="border-color:#D8D8D8;"><div class="box_holder_inner left">
						<p>
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'Sports', 'tag' => 'featured', 'posts_per_page' => 5);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						?>
						<b><a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );?> <img src="<?php echo $url; ?>" alt="<?php the_title();?>" width="32" height="32" style="vertical-align:middle; margin-right:10px; border-style:solid; border-width:0px; border-radius:20px;" /><?php the_title(); ?><span style="float:right;"><i class="icon-ticket"></i></span></a></b></br>
						<?php endwhile; endif; ?></p>
						<?php wp_reset_query(); ?>
						<span style="float:right;"><a href="http://www.tickethub.co/sports">All Sports</a></span>
					</div></div>
				</div> 
			</div> 
		</div>
		...
		<div class="wpb_row vc_row-fluid" style="text-align:left;">
				<div class="vc_span4 wpb_column column_container">
					...
					<div class="box_holder" style="border-color:#D8D8D8;"><div class="box_holder_inner left">
						<p>
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'Artist', 'tag' => 'featured', 'posts_per_page' => 5);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						?>
						<b><a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php the_title(); ?><span style="float:right;"><i class="icon-ticket"></i></span></a></b></br>
						<?php endwhile; endif; ?></p>
						<?php wp_reset_query(); ?>
					</div></div>
				</div> 
			...
			<div class="vc_span4 wpb_column column_container">
					...
					<div class="box_holder" style="border-color:#D8D8D8;"><div class="box_holder_inner left">
						<p>
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'Broadway', 'tag' => 'featured', 'posts_per_page' => 5);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						?>
						<b><a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php the_title(); ?><span style="float:right;"><i class="icon-ticket"></i></span></a></b></br>
			...
			<div class="vc_span4 wpb_column column_container">
					...
					<div class="box_holder" style="border-color:#D8D8D8;"><div class="box_holder_inner left">
						<p>
						<?php 
						$args = array( 'post_type' => 'portfolio_page', 'portfolio_category' => 'Venue', 'tag' => 'featured', 'posts_per_page' => 5);
						$loop = new WP_Query( $args );
						if ( have_posts() ): while ( $loop->have_posts() ) : $loop->the_post();
						?>
						<b><a href="<?php the_permalink();?>" title="<?php the_title(); ?> Tickets"><?php the_title(); ?><span style="float:right;"><i class="icon-ticket"></i></span></a></b></br>
