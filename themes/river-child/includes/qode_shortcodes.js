            ...
            onclick : function() {
              ...
              jQuery('#qode_shortcodes_menu_holder').load(url + '/qode_shortcodes_popup.html#qode_shortodes_popup', function(){
						...
						jQuery("#SC_parallax").click(function(){
							var shortcode = "[vc_parallax]<br/><br/>[vc_parallax_section anchor='' title='Section name' background_image='32' height='400' position='center']<p>Enter content here</p>[/vc_parallax_section]<br/><br/>[/vc_parallax]";
						...
						jQuery("#SC_blockquotes").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_blockquotes.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								   ...
								   var background_color = jQuery('#TB_window #background_color').val();
								   var border_color = jQuery('#TB_window #border_color').val();
                                                                   var shortcode = "[blockquote text='"+text+"' text_color='"+text_color+"' width='"+width+"' background_color='"+background_color+"' border_color='"+border_color+"']";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });							
						...
						jQuery("#SC_dropcaps").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_dropcaps.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								   ...
								   var shortcode = "[dropcaps color='"+color+"' background_color='"+background_color+"' border_color='"+border_color+"' type='"+type+"']" + letter + "[/dropcaps]";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });							
                        ...
                        jQuery("#SC_icon_text").click(function() {
                            ...
                            jQuery.get(url + "/qode_shortcodes_icons_text.php", function(data) {
                                ...
                                jQuery('#TB_window #qode_insert_shortcode_button').click(function() {
                                    ...
                                    var shortcode = "[icon_text box_type='" + box_type + "' box_border='" + box_border + "' box_border_color='" + box_border_color + "' box_background_color='" + box_background_color + "' icon='" + icon + "' icon_type='" + icon_type + "' icon_size='" + icon_size + "' custom_icon_size='" + custom_icon_size + "' icon_animation='"+icon_animation+"' icon_animation_delay='"+icon_animation_delay+"' image='" + image + "'  icon_position='" + icon_position + "' icon_margin='"+icon_margin+"' icon_border='" + icon_border + "' icon_border_color='" + icon_border_color + "' icon_color='" + icon_color + "'  icon_background_color='" + icon_background_color + "'  title='" + title + "' title_tag='"+title_tag+"' text='" + text + "' title_color='" + title_color + "' text_color='" + text_color + "']";
                                    jQuery("#qode_shortcode_form_wrapper").remove()
                                    ed.execCommand('mceInsertContent', false, shortcode);
                                    tb_remove();
                                    return false;
                        ...
                        jQuery("#SC_line_graph").click(function() {
                            ...
                            jQuery.get(url + "/qode_shortcodes_line_graph.php", function(data) {
                                ...
                                jQuery('#TB_window #qode_insert_shortcode_button').click(function() {
                                    ...
                                    var shortcode = "[line_graph " + width + " " + height + " " + scaleSteps + " " + scaleStepWidth + " custom_color='" + custom_color + "' type='" + type + "' labels='Label 1, Label 2, Label 3']#f54325,Legend One,1,5,10;#fea899,Legend Two,3,7,20;#ffd7d0,Legend Three,10,2,34[/line_graph]";
                                    jQuery("#qode_shortcode_form_wrapper").remove()
                                    ed.execCommand('mceInsertContent', false, shortcode);
                                    tb_remove();
                                    return false;
						...
						jQuery("#SC_message").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_message.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
								   ...
								   var shortcode = "[message type='"+type+"' icon='"+icon+"' icon_color='"+icon_color+"' custom_icon='"+custom_icon+"' background_color='"+background_color+"' border_color='"+border_color+"' close_button_style='"+close_button_style+"']<h4>Message Title</h4>[/message]";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });							
						...
						jQuery("#SC_pie_chart").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_pie_chart.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
                                    ...
                                    var title_tag = jQuery('#TB_window #title_tag option:selected').val();
									var text = jQuery('#TB_window #text').val();
								    var shortcode = "[pie_chart percent='"+percentage+"' percentage_color='"+percentage_color+"' active_color='"+active_color+"' noactive_color='"+noactive_color+"' line_width='"+line_width+"' title='"+title+"' title_color='"+title_color+"' title_tag='"+title_tag+"' text='"+text+"']";
								    jQuery("#qode_shortcode_form_wrapper").remove()
								    ed.execCommand('mceInsertContent', false, shortcode);
								    tb_remove();
								    return false;
						...
						jQuery("#SC_pie_chart2").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_pie_chart2.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									 ...
									 var color = jQuery('#TB_window #color').val();
									 var shortcode = "[pie_chart2 "+width+" "+height+" color='"+color+"']15,#f54325,Legend One; 35,#fea899,Legend Two; 50,#ffd7d0,Legend Three[/pie_chart2]";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });							
						...
						jQuery("#SC_pie_chart3").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_pie_chart3.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									 ...
									 var color = jQuery('#TB_window #color').val();
									 var shortcode = "[pie_chart3 "+width+" "+height+" color='"+color+"']15,#f54325,Legend One; 35,#fea899,Legend Two; 50,#ffd7d0,Legend Three[/pie_chart3]";
								   jQuery("#qode_shortcode_form_wrapper").remove()
								   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
								   return false;
							   });							
						...
						jQuery("#SC_image_with_text_over").click(function(){
							...
							jQuery.get(url + "/qode_shortcodes_image_with_text_over.php", function(data){
							   ...
							   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
									...
									var shortcode = "[image_with_text_over image='"+image+"' title='"+title+"' title_color='"+title_color+"' subtitle='"+subtitle+"' subtitle_color='"+subtitle_color+"' line_color='"+line_color+"' title_size='"+title_size+"' title_tag='"+title_tag+"']<p>Enter text here</p>[/image_with_text_over]";
									jQuery("#qode_shortcode_form_wrapper").remove()
									ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
									return false;
							   });
                        ...
                        jQuery("#SC_steps").click(function() {
                            ...
                            jQuery.get(url + "/qode_shortcodes_steps.php", function(data) {
                                ...
                                jQuery('#TB_window #qode_insert_shortcode_button').click(function() {
                                    ...
                                    //add general params
                                    var shortcode = "[steps number_of_steps='"+number_of_steps+"' background_color='"+background_color+"' number_color='"+number_color+"' title_color='"+title_color+"' title_tag='"+title_tag+"' ";
