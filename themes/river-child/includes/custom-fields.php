						...
						<div class="form-field form-required">
							...
							switch ( $customField[ 'type' ] ) {
								...
								case "selectbox_title_style": {
									...
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
										<option value="1" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "1" ) { ?> selected="selected" <?php } ?>>Standard</option>    
										<option value="2" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "2" ) { ?> selected="selected" <?php } ?>>With breadcrumb in title</option>    
                                    <?php 
                                    echo '</select>';
									break;
								}
								...
								case "selectbox-animation": {
									$page_transitions = "2";
									if (isset($qode_options_river['page_transitions'])) $page_transitions = $qode_options_river['page_transitions'];
