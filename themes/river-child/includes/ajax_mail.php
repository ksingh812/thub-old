...
$use_captcha = $qode_options_river['use_recaptcha'];
if ($resp->is_valid || $use_captcha == "no") {
?>success<?php

$email_to = $qode_options_river['receive_mail'];
$email_from = $qode_options_river['email_from'];
$subject = $qode_options_river['email_subject'];
